...
/**
 * Enth&auml;lt die medizinischen Daten einer UZE- Weisung.
 */
public class MedDaten {
  ...
  private MedDatenErweiterung[] _weitereMedizinischeInformationen;
  ...
  /**
   * Enthält weitere medizinische Informationen die aufgrund unterschiedlicher SS12 beziehungsweise 
   * Clientversion bei Erstellung beziehungsweise Abfrage nicht über die Schnittstelle transportiert werden könnten.<br/>
   * Format: maximal 6.
   * @return WeitereMedizinischeInformationen
   */
  public MedDatenErweiterung[] getWeitereMedizinischeInformationen() {
    return _weitereMedizinischeInformationen;
  }
   ...
   * Clientversion bei Erstellung beziehungsweise Abfrage nicht über die Schnittstelle transportiert werden könnten.<br/>
   * Format: maximal 6.
   * @param weitereMedizinischeInformationen
   */
  public void setWeitereMedizinischeInformationen(MedDatenErweiterung[] weitereMedizinischeInformationen) {
    _weitereMedizinischeInformationen = weitereMedizinischeInformationen;
  }
