...
/**
 * Enth&auml;lt die Eingangsdaten der Funktion searchModifiableUzeLa.
 */
public class ModifiableUzeLaSearchReq {
  ...
  /**
   * Code des Status von modifizierbaren UZEs.<br>
   * Mögliche Werte siehe {@link at.chipkarte.client.uze.soap.constants.ModStatus ModStatus}.<br>
   * Format: 1-stellig.
   * @return Status
   */
  ...
  /**
   * Der generierte Code der UZE, die auf Modifizierbarkeit abgefragt werden soll.<br>
   * Gemeinsam mit der SV-Nummer ist er ein eindeutiges Identifizierungsmerkmal der UZE.<br>
  ...
  /**
   * Versicherungsnummer des Patienten, dessen UZE  auf Modifizierbarkeit abgefragt werden sollen.<br>
   ...
   * Wenn nicht angegeben, wird nach allen Weisungstypen gesucht.<br>
