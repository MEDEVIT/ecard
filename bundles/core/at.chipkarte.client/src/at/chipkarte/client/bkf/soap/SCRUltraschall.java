 ...
 * Die Angabe eines Ultraschalls ist bei der Screeningdokumentation optional. Wird <i>SCRUltraschall</i> 
...
public class SCRUltraschall {
   ...
   * <ul>
   * <li><b>'1'</b>: Erstbefunderangaben (<i>SCRMammographieErstbefunder</i>) 
   ...
   * <li><b>'2'</b>: Erstbefunderangaben (<i>SCRMammographieErstbefunder</i>) 
   ...
   * <li><b>'5'</b>: Zweitbefunderangaben (<i>SCRMammographieZweitbefunder</i>) 
   * - der Parameter <i>Dichte</i> (Ergebnis Dichte (D-SCORE)) muss mit 3 
   * ('D3') oder 4 ('D4') und  der Parameter <i>Ergebnis</i> (Ergebnis Mammographie (MG-SCORE)) mit '1' ('MG1') 
   * oder '2' ('MG2') befüllt sein</li>
   * <li><b>'6'</b>: Zweitbefunderangaben (<i>SCRMammographieZweitbefunder</i>) muss
