...
/**
 * Fehlerkonstanten, die im Zusammenhang mit Konsultationen vom e-card Serversystem geworfen
...
public class KseExceptionConstants {
   ...
   * <br>ORCLI-Code: CL-00020, Cl-00053, CL-00203 (ZS-00044) 
   */
  ...
  /**
   * SV-Person hat keinen gültigen Krankenversicherungsanspruch.
  ...
  /**
   * Alle erlaubten Erstkonsultationen für das angegebene Fachgebiet und den angegebenen Svt wurden
   * bereits verbraucht.
  ...
  /**
   * Alle erlaubten Erstkonsultationen für die Fachgebietsgruppe und den angegebenen Svt wurden
   * bereits verbraucht.
  ...
  /**
   * SV-Person hat keinen gültigen Krankenversicherungsanspruch zum gewählten Svt.
  ...
  /**
   * Es existiert kein gültiger Vertragspartner-Vertrag zum Svt der SV-Person.
  ...
  /**
   * Es liegt eine Mehrfachversicherung vor  Svt muss erfasst werden. Die zur Auswahl stehenden
   ...
   * auch das Vertragspartner - Benutzerhandbuch der aktuellen Release,  Kapitel "Patient hat
   ...
   * kann nicht synchron durchgeführt werden. <br>
   * ORCLI-Code: ZS-00052
   */
  ...
  /**
   * Der Zeitabstand seit der letzten Konsultation mit diesem Behandlungsfall ist für die SV-Person
   * zu gering.
  ...
  /**
   * Konsultation ist bereits storniert.
  ...
  /**
   * Die Aufbewahrungsfrist für offline Konsultationen ist überschritten.
   ...
   * Anspruchsnutzung, zum SVT der stornierten Konsultation genehmigt ist. Hinweis: FG-Quartalsanspruch: Bei der ersten
   * Konsultation innerhalb eines FG und des aktuellen Quartal muss sich die SV-Person, bei Mehrfachversicherung bei ASVG-Kassen,
   * für einen der Ansprüche entscheiden. Nur der ausgewählte Anspruch, die Sonderversicherungs-träger-Ansprüche und zusätzlich
   ...
   * kann für eine SV-Person, vom entsprechenden SVT, eine zusätzliche Anspruchsnutzung eines ASVG-Anspruchs für das FG und das
  ...
  /**
   * Der Patient ist nur für Vorsorge(Gesunden)untersuchungen und für Leistungen aus dem Mutter-Kind-Pass Programm anspruchsberechtigt.
   ...
   * Bitte melden Sie einen neue Dialog mit der Ordinationskarte an um die Offline-Funktionalität nutzen zu können.
  ...
  /**
   * Für die angegebene Zusatzinformations-AntwortID wurde bereits eine Antwort übermittelt.
   * <br>ORCLI-Code: ZS-00092
   */
  public static final int ZUSATZINFO_ANTWORTID_ALREADY_USED = 124;
  
  /**
   * Die Konsultation zu der die Zusatzinformationen angezeigt wurde, 
  ...
  /**
   * Die angegebene Zusatzinformations-AntwortID ist nicht bekannt.
