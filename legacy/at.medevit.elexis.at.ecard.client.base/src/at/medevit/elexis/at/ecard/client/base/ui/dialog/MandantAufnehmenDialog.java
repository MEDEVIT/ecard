...
public class MandantAufnehmenDialog extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public MandantAufnehmenDialog(Shell parentShell){
		super(parentShell);
	}
	 ...
	 */
	public MandantAufnehmenDialog(Shell parentShell, Card cardData){
		super(parentShell);
		...
		m_VPNR = (cardData.getNummer() != null) ? cardData.getNummer() : "";
		m_Geschlecht = (cardData.getGeschlechtCode() != null) ? cardData.getGeschlechtCode() : "";
	}

//	public MandantAufnehmenDialog(Shell parentShell, SvPerson p){
//		super(parentShell);
//		
...
//		m_HVNR = (p.getSvNummer() != null) ? p.getGeburtsdatum() : "";
...
//	}
	...
	protected Control createDialogArea(Composite parent){
		setMessage("Mandant ist derzeit nicht im System geführt.");
		setTitle("Mandant erstellen");
		...
		Label lblVpnr = new Label(container, SWT.NONE);
		lblVpnr.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
		lblVpnr.setText("VPNR");
		
		txtVpnr = new Text(container, SWT.BORDER | SWT.READ_ONLY);
		txtVpnr.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 4, 1));
		txtVpnr.setText(m_VPNR);
	...
	protected void createButtonsForButtonBar(Composite parent){
		...
		// TODO Einen "neuen" Patienten einem bestehenden Patienten zuweisen
